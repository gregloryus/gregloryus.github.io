...
const BOTTOM_SECTION_START = rows * 0.75; // Start of the bottom heating section
const BOTTOM_SECTION_END = rows; // End of the bottom heating section
const CENTRAL_AREA_START = cols * 0.2; // Start of the central heating area horizontally
const CENTRAL_AREA_END = cols * 0.8; // End of the central heating area horizontally
...
// Attraction Force
const ATTRACTION_FORCE_MAGNITUDE = 0.1;
