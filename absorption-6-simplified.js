...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const CONSTANTS = {
    ...
    VISUAL: {
      ...
      ENERGY_PARTICLE_ALPHA: 0.1, // Individual energy particles
      ...
      PHANTOM_HORIZONTAL_OFFSET_RATIO: 0.33, // _/_ of canvas width
    ...
    PHYSICS: {
      ...
      FLOW_DIRECTION_CHANCE: 0.9, // _% chance for first choice in directional decisions
      WATER_DIAGONAL_CHANCE: 0.3, // Chance water takes diagonal path
    ...
    FLUX: {
      P_ENERGY: 0.01, // _% chance per tick for energy spawning near leaves
    ...
    FLOW: {
      FIXED_PARTICLE_UPDATE_FREQUENCY: 10, // Fixed particles move every _ ticks
  ...
  class Particle {
    ...
    updateBoundParticle() {
      ...
      if (!this.flowDirection) {
        this.flowDirection =
          Math.random() < CONSTANTS.PHYSICS.FLOW_DIRECTION_CHANCE
            ? "preferred"
            : "any";
      }
