...
const CONSTANTS = {
  ...
  MUTATION_RATE: 0.1, // 50% of initial seeds mutated, also used for offspring
  ...
  // Germination
  GERMINATION_CLEAR_RADIUS: 2, // Must have this many cells clear around landing spot
};
