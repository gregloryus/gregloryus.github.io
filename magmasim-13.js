...
const TEMPERATURE_AVERAGING_FACTOR = 0.001;
...
const TEMPERATURE_DIFFERENCE_THRESHOLD = 30; // Temperature difference threshold for changing attraction/repulsion behavior
const TEMPERATURE_CLOSE_THRESHOLD = 10; // Temperature difference threshold for stronger attraction
const TEMPERATURE_FAR_THRESHOLD = 20; // Temperature difference threshold for weaker attraction
