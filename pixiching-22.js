// TO DO NEXT:
// - Update the element names for 5 characters (i.e., VAPOR, PLANT, DECAY, FLAME, EARTH, WATER)
// - Expand on the LIFE --> SOIL process, ideally making it somewhat contagious, if it'd be too impractical to literally track parents and children...
// - Refine the SOIL --> RAIN process, since it's way over-simplified right now;
