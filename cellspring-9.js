...
class PlantCell {
  constructor(x, y, parent = null, type) {
    ...
    // Add energy text display
    this.energyText = new PIXI.Text("5", {
      fontFamily: "Arial",
  ...
  updateVisuals() {
    ...
    // Update text position in case cell moved
    this.energyText.x = this.sprite.x + scaleSize / 2;
    this.energyText.y = this.sprite.y + scaleSize / 2;
  }
  ...
  die() {
    ...
    app.stage.removeChild(this.energyText); // Remove energy text when cell dies
  }
}
