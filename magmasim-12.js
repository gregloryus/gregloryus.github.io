...
const TEMPERATURE_DIFFERENCE_THRESHOLD = 3; // Temperature difference threshold for changing attraction/repulsion behavior
const TEMPERATURE_CLOSE_THRESHOLD = 1; // Temperature difference threshold for stronger attraction
const TEMPERATURE_FAR_THRESHOLD = 2; // Temperature difference threshold for weaker attraction
