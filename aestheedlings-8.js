...
const CONSTANTS = {
  // Growth parameters
  GROWTH: {
    BRANCH_CHANCE: 0.1, // Increased for more branching
    LEAF_CHANCE: 0.9, // 80% chance to create a leaf bud
    DIAGONAL_GROWTH_WEIGHT: 0.75, // Lowered for less diagonal growth
    ...
    BUD_SIZE_LIMIT_MIN: 10, // Minimum particles a bud can create before maturing
    BUD_SIZE_LIMIT_MAX: 80, // Maximum particles a bud can create before maturing
  },
